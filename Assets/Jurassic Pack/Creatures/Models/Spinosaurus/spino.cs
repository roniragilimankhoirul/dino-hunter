...
public class spino : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		...
		//Various
		else if(CurrAnm.IsName("Spino|EatA")) { reset=true; PlaySound("Food", 4); PlaySound("Bite", 5); }
		...
		else if(CurrAnm.IsName("Spino|Die1-")) { shared.IsConstrained=true; PlaySound("Growl", 3);  shared.IsDead=false; }
		else if(CurrAnm.IsName("Spino|Die2-")) { shared.IsConstrained=true; PlaySound("Growl", 3);  shared.IsDead=false; }
	}
